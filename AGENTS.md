...
This repository contains the **10x Astro Starter**, a modern server-side rendered web application built with Astro v6, React v19, Tailwind CSS v4, and Supabase. Deployments target Vercel.
...
- `npm run build` – Compile the production build optimized for `@astrojs/vercel`.
